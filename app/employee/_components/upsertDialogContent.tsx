...
interface UpsertDialogEmployeeComponentProps {
  onSuccess?: () => void;
  isOpen?: boolean;
}
...
export default function UpsertDialogEmployeeComponent({
  onSuccess,
  isOpen,
}: UpsertDialogEmployeeComponentProps) {
    ...
    <DialogContent className="bg-white">
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Preencha as informaçoes para cadastrar um novo colaborador
          </DialogDescription>
        </DialogHeader>
        <FieldGroup>
          <Controller
